...
public abstract class AbstractMessageResouce implements MessageResource {
    ...
    protected void loadResource() {
        defaultPropties = (Properties) loadResource(DEFAULT_RESOURCE_FILE + DEFAULT_RESOURCE_FILE_SUFFIX).clone();
    }
    ...
    public String getMessage(MessageCode code, Locale language, String... args) {
        ...
        if (languageProps.containsKey(defaultLanguage)) {
            ...
            prop = loadResource(
                    DEFAULT_RESOURCE_FILE + (StringUtils.isBlank(defaultLanguage) ? "" : "_") + defaultLanguage + DEFAULT_RESOURCE_FILE_SUFFIX);
