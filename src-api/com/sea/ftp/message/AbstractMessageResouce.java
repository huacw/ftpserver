...
public abstract class AbstractMessageResouce implements MessageResource {
	// 默认的国际化文件地址
	protected final static String DEFAULT_RESOURCE_FILE = "com/sea/ftp/message/message%s.properties";
	// 默认的资源配置
	...
	protected void loadResource() {
		defaultPropties = (Properties) loadResource(String.format(DEFAULT_RESOURCE_FILE, "")).clone();
	}
	...
	protected Properties loadResource(String resouceFile) {
		...
		try {
			props.load(getClass().getClassLoader().getResourceAsStream(resouceFile));
		} catch (IOException e) {
